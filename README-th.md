...
43 template พร้อมใช้งาน ครอบคลุมทุกขั้นตอนของการพัฒนาซอฟต์แวร์:
...
- **ความปลอดภัย**: Architecture Review, Threat Model (STRIDE), ประเมิน OWASP, รายงานความปลอดภัย, แผนแก้ไข, นโยบาย
...
```
วิเคราะห์ความต้องการ --> ออกแบบสถาปัตยกรรม --> DBA --> ตรวจสอบความปลอดภัย (Review) --> ออกแบบ UX/UI --> วางแผน Sprint
                                                                                                          |
                                                                                                   พัฒนาแบบ Sprint-based
                                                                                                   ├─ Sprint N: พัฒนา → ตรวจสอบโค้ด → Security Scan
                                                                                                   └─ Sprint Review ทุก Sprint
                                                                                                          |
                                                                                                   ทดสอบคุณภาพ
                              |
...
├── templates/                   # Template เอกสารส่งมอบ 43 ไฟล์
...
│   ├── 06-security/             #   เอกสารความปลอดภัย (6 ไฟล์)
